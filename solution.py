...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="RightLowerLeg", pos=[x,y,z-1] , size=[length-0.6,width-0.6,height])
    ...
    pyrosim.Send_Cube(name="LeftLowerLeg", pos=[x,y,z-1] , size=[length-0.6,width-0.6,height])
