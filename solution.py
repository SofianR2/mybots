...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="FrontLowerLeg", pos=[x,y,z-1] , size=[length-0.8,width,height])
    ...
    pyrosim.Send_Cube(name="BackLowerLeg", pos=[x,y,z-1] , size=[length-0.8,width,height])
