...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="FrontLowerLeg", pos=[x,y,z-0.5] , size=[length-0.2, width-0.8, height])
    ...
    pyrosim.Send_Cube(name="BackLowerLeg", pos=[x,y,z-0.5] , size=[length-0.2, width-0.8, height])
