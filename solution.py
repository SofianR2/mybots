...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="FrontLowerLeg", pos=[x,y,z-1] , size=[length-0.8, width-0.2, height])
    ...
    pyrosim.Send_Cube(name="BackLeg", pos=[x,y-0.5,z-0.5] , size=[length-0.2,width-0.8,height-0.8])
