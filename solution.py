...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Sphere(name="FrontLowerLeg", pos=[x,y,z-1] , size=[length+0.2,width-0.8,height])
    ...
    pyrosim.Send_Sphere(name="BackLowerLeg", pos=[x,y,z-1] , size=[length+0.2,width-0.8,height])
