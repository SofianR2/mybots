...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="RightShoe", pos=[x-0.5,y,z-0.5] , size=[length,width-0.6,height-0.8])
    ...
    pyrosim.Send_Cube(name="LeftShoe", pos=[x-0.5,y,z-0.5] , size=[length,width-0.6,height-0.8])
