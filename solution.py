...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="LowerRightArm", pos=[x,y,z] , size=[length,width-0.8,height-0.8])
    ...
    pyrosim.Send_Cube(name="LowerLeftArm", pos=[x,y,z] , size=[length,width-0.8,height-0.8])
