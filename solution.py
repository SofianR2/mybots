...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Joint(name = "Torso_RightArm" , parent= "Torso" , child = "RightArm" , type = "revolute", position = [x,y+0.5,z+0.5+height_offset], jointAxis = "0 1 0")
    pyrosim.Send_Cube(name="RightArm", pos=[x,y,z] , size=[length-0.4,width-0.4,height-0.5])
