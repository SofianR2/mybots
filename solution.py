...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="RightLeg", pos=[x,y,z-1] , size=[length-0.8,width-0.8,height+1])
    ...
    pyrosim.Send_Cube(name="LeftLeg", pos=[x,y,z-1] , size=[length-0.8,width-0.8,height+1])
