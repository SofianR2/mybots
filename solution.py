...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Cube(name="RightLowerLeg", pos=[x,y,z-2] , size=[length-0.2,width-0.2,height])
    ...
    pyrosim.Send_Cube(name="LeftLowerLeg", pos=[x,y,z-2] , size=[length-0.2,width-0.2,height])
