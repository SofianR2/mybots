...
class SOLUTION:
  ...
  def Create_Body(self):
    ...
    pyrosim.Send_Joint(name = "Torso_RightLeg" , parent= "Torso" , child = "RightLeg" , type = "revolute", position = [x,y,z+height_offset], jointAxis = "0 1 0")
    pyrosim.Send_Cube(name="RightLeg", pos=[x,y,z-0.5] , size=[length,width,height])
    '''
