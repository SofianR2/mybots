...
def Create_Robot():
  ...
  pyrosim.Send_Joint( name = "Link2_Link3" , parent= "Link2" , child = "Link3" , type = "revolute", position = [x+0.5,y,z])
  pyrosim.Send_Cube(name="Link3", pos=[x+1,y,-0.5] , size=[length,width,height])
  pyrosim.End()
