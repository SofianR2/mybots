...
def Create_Robot():
  ...
  pyrosim.Send_Joint( name = "BackLeg_FrontLeg" , parent= "BackLeg" , child = "FrontLeg" , type = "revolute", position = [x+1,y,z-0.5])
  pyrosim.Send_Cube(name="FrontLeg", pos=[x+1.5,y,z-1] , size=[length,width,height])
